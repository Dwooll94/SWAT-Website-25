          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="p-0 rounded-md hover:bg-swat-green transition-colors"
              ...
              <Link to="/" className="flex items-center space-x-2">
                <img 
                  ...
                  className="h-auto max-h-10 w-auto swat-logo"
                />
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                ...
                <>
                  ...
                  <Link 
                    to="/register" 
                    className="bg-swat-green hover:bg-swat-green-dark px-2 py-2 rounded font-medium transition-colors text-nowrap"
                  >
                    Join Team
                  </Link>
                </>
